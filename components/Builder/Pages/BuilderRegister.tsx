...
const BuilderRegister: React.FC = () => {
  ...
  const steps: StepConfig[] = [
    ...
    { id: FormSteps.SIGNATORY, title: "Signatory", description: "Authorized Person", icon: <FontAwesomeIcon icon={faUser} /> },
  ...
  const specializations = [
    "Luxury Homes", "Affordable Housing", "Commercial Complex", "Industrial Parks",
    "Green Building", "Renovation", "Interior Design", "Civil Construction"
  ];
  ...
  const handleSpecializationChange = (specialization: string) => {
    setFormData(prev => {
      const updated = prev.specialization.includes(specialization)
  ...
  const handleCityChange = (city: string) => {
    setFormData(prev => {
      const updated = prev.cities.includes(city)
  ...
  const handleVerifyOTP = () => {
    if (formData.otp === "123456") { // Simulated OTP
  ...
  const validateCurrentStep = (): boolean => {
    ...
    switch (currentStep) {
      ...
      case FormSteps.SIGNATORY:
        if (!formData.signatoryName.trim()) newErrors.signatoryName = "Signatory name required";
  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      if (typeof window !== 'undefined') {
        ...
        localStorage.setItem("currentBuilder", JSON.stringify({
    ...
    switch (currentStep) {
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 text-sm bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors"
                >
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 text-sm bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors"
                  >
                    Verify
                  </button>
                </div>
      ...
      case FormSteps.SIGNATORY:
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-semibold mb-1 text-gray-700">Signatory Name *</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <input
                  ...
                  className={`w-full pl-9 pr-3 py-2.5 text-sm border rounded-lg outline-none transition-all duration-200 ${
                    errors.signatoryName ? "border-red-500" : "border-gray-300 focus:border-purple-500"
                  }`}
                />
              </div>
              {errors.signatoryName && <p className="text-red-500 text-xs mt-1">{errors.signatoryName}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 text-sm border rounded-lg outline-none transition-all duration-200 ${
                  errors.designation ? "border-red-500" : "border-gray-300 focus:border-purple-500"
                }`}
              />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-9 pr-3 py-2.5 text-sm border rounded-lg outline-none transition-all duration-200 ${
                    errors.contactNumber ? "border-red-500" : "border-gray-300 focus:border-purple-500"
                  }`}
                />
              </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-4">
                By registering, you agree to abide by our platform rules, maintain quality standards,
                provide accurate information, and comply with all applicable laws and regulations.
              </p>
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Your personal and business information will be used for verification purposes,
                platform access, and to provide you with relevant services. We respect your privacy
                and will not share your data without consent.
              </p>
              <label className="flex items-start">
                <input
                  type="checkbox"
          ...
          <div className="space-y-4">
            <div className="p-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between border-b pb-2">
                  ...
                  <span className="font-medium">{formData.signatoryName}</span>
                </div>
                <div className="flex justify-between border-b pb-2">
            ...
            <div className="p-4 bg-yellow-50 rounded-lg">
              <p className="text-sm text-yellow-800">
                ⚠️ Your account will be reviewed by our admin team. Approval usually takes 24-48 hours.
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-3 sm:px-6 lg:px-12  bg-gradient-to-br from-purple-50 to-indigo-50">

      <div className="w-full max-w-5xl xl:max-w-6xl 2xl:max-w-7xl px-2 sm:px-4">
        ...
        {/* Stepper */}
        <div className="mb-8">
         <div className="flex items-center justify-between relative overflow-x-auto gap-4">
            ...
            {steps.map((step, index) => (
              <div key={step.id} className="flex flex-col items-center relative z-10">
                ...
                <div className="text-center">
                  ...
                  <p className={`text-sm font-semibold hidden md:block ${currentStep >= step.id ? "text-gray-800" : "text-gray-400"}`}>
                    {step.title}
                  </p>
                </div>
              </div>
