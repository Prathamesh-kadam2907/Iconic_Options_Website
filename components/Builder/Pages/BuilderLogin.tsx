...
const BuilderLogin = () => {
    ...
    const handlePasswordLogin = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('http://10.238.166.94:5000/api/auth/login', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                body: JSON.stringify({
                    email: mobile, // or inputemail
                    password: password,
                }),
            });
        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-gray-900 to-blue-900 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
                    ...
                    <div className="flex border-b border-white/20">
                        <button
                            ...
                            className={`flex-1 py-4 text-center font-medium transition-all ${loginMethod === 'password' ? 'bg-white/20 text-white' : 'text-blue-200 hover:bg-white/10'}`}
                        >
                        ...
                        <button
                            ...
                            className={`flex-1 py-4 text-center font-medium transition-all ${loginMethod === 'otp' ? 'bg-white/20 text-white' : 'text-blue-200 hover:bg-white/10'}`}
                        >
                    ...
                    <div className="p-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute inset-y-0 right-0 pr-3 flex items-center">
                                                <span className="text-blue-400 hover:text-white transition-colors">{showPassword ? 'Hide' : 'Show'}</span>
                                            </button>
                                        </div>
                                        <div className="mt-2 text-right">
                                            <Link href="/builder/forgot-password" className="text-sm text-teal-400 hover:text-teal-300 transition-colors">
                                                Forgot Password?
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    >
                                        {isLoading ? (
                                            ...
                                            <div className="flex items-center justify-center" onClick={handlePasswordLogin}>
                                                Login to Dashboard
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button type="button" onClick={handleSendOTP} className="px-4 py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors whitespace-nowrap">
                                    ...
                                    {otpSent && (
                                        <div>
                                            <label className="block text-sm font-medium text-blue-200 mb-2">Enter OTP *</label>
                                            <div className="relative">
                                                <input
                                                    type="text"
                                                    value={otp}
                        ...
                        <div className="text-center">
                            <p className="text-blue-200 mb-4">Join our network of professional builders and grow your business</p>
                            <button
                ...
                <div className="mt-6 text-center">
                    ...
                    <p className="mt-2 text-blue-400 text-sm">By logging in, you agree to our Terms & Privacy</p>
                </div>
            </div>
        </div>
    );
