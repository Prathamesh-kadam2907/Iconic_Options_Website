        ...
        <div className="container mx-auto">
            <div className="bg-white rounded-xl p-4 sm:p-5 md:p-6 lg:p-8 xl:p-10">
                <div className="text-center mb-6 sm:mb-8">
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 sm:mb-3">Top Real Estate Builders</h2>

                    <p className="text-gray-600 max-w-2xl mx-auto text-xs sm:text-sm md:text-base px-2">Explore trusted real estate builders delivering quality homes across prime locations.</p>
                ...
                "
                    ...
                    "
                                ...
                                <h3 className="text-base sm:text-lg font-semibold text-center mb-1 sm:mb-2 text-gray-800">{builder.name}</h3>

                                <p className="text-xs sm:text-sm text-gray-600 text-center mb-3 sm:mb-4">{builder.description}</p>
                                ...
                                <div className="text-xs sm:text-sm text-gray-700 space-y-1 sm:space-y-2">
                                    ...
                                    <p className="flex justify-between">
                                        ...
                                        <span className="text-right">{builder.cities.join(', ')}</span>
                                    </p>
                                </div>
