...
const CommericalPropertyCard = ({ data }) => {
    ...
    >
      ...
      <div className="flex p-2 gap-2">
        ...
        <div className="flex-1 grid grid-cols-2 gap-2 text-xs">
          ...
          <div className="flex items-center gap-1.5 border border-gray-300 p-1.5 rounded-md">
            <div>
              <p className="font-medium">{data.propertyType || "Office Space"}</p>
          ...
          <div className="flex items-center gap-1.5 border border-gray-300 p-1.5 rounded-md">
            <div>
              <p className="font-medium">{data.tenant || "Any"}</p>
...
export default CommericalPropertyCard;